...
const Footer: React.FC = () => {
  ...
  return (
    <footer className={`py-12 ${isDarkMode ? 'bg-netflix-black' : 'bg-gray-800'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Logo et description */}
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-netflix-red text-2xl font-bold mb-4">StreamFlix</h3>
            <p className="text-gray-400 mb-4">
              Votre destination pour les meilleurs films et séries. Découvrez un monde d'histoires infinies.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Ma Liste</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 StreamFlix. Tous droits réservés.
          </p>
        </div>
      </div>
    </footer>
